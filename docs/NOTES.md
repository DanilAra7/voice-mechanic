...
Открытый вопрос: у gpt-oss-20b снизить reasoning effort (harmony-формат, `Reasoning: low`) и
переснять TTFT — иначе кандидат выбывает не по уму, а по формату вывода.
